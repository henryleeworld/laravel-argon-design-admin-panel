...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="g-sidenav-show bg-gray-100">
                    ...
                    <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                        ...
                        <ul class="navbar-nav justify-content-end">
                            ...
                            <li class="nav-item dropdown ps-2 d-flex align-items-center">
                                <a href="javascript:;" class="nav-link text-white p-0" id="dropdownLanguageMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <li class="nav-item dropdown ps-2 d-flex align-items-center">
                                <a href="javascript:;" class="nav-link text-white p-0" id="dropdownAccountMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <script src="//cdn.datatables.net/1.13.10/js/jquery.dataTables.min.js"></script>
